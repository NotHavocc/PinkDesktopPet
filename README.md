...
[Download for Windows (.exe)](https://github.com/NotHavocc/PinkDesktopPet/releases/download/v1.2.0/PinkDesktopPet.exe)\
[Universal Script (anyplatform) (.py)](https://github.com/NotHavocc/PinkDesktopPet/archive/refs/tags/v1.2.0.zip)\
